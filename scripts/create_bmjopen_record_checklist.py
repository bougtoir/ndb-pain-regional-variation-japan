#!/usr/bin/env python3
"""Create STROBE/RECORD checklist for BMJ Open submission.

BMJ Open requires EQUATOR reporting checklists for all study types.
"""
...
journal_line = doc.add_paragraph()
journal_line.alignment = WD_ALIGN_PARAGRAPH.CENTER
run3 = journal_line.add_run('Submitted to: BMJ Open')
run3.font.size = Pt(9)
run3.italic = True
...
items = [
    ...
    ('Title and abstract', '1', 'STROBE 1(b): Provide an informative and balanced summary of what was done and found', 'Structured abstract (Objectives, Design, Setting, Participants, Outcome measures, Results, Conclusions)', 'Abstract'),
...
outpath = os.path.join(BMJOPEN_DIR, 'BMJOpen_STROBE_RECORD_checklist.docx')
doc.save(outpath)
