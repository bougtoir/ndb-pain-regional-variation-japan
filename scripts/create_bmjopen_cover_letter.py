#!/usr/bin/env python3
"""Create cover letter for BMJ Open submission."""
...
body_paras = [
    (
        ...
        'Variation in Japan\u201d '
        'for consideration as an Original Research article in BMJ Open. '
        'This manuscript was transferred from the Journal of Epidemiology '
        'and Community Health at the suggestion of its editors.'
    ),
    (
...
more_paras = [
    (
        'We believe this manuscript aligns well with BMJ Open\u2019s scope and readership. '
        'The study addresses population-level variation in pain management using a novel '
        'ecological framework applied to population-complete national claims data. '
        'The finding that cultural stereotypes fail to predict prescribing patterns '
        'has implications for health equity and clinical practice globally\u2014not only '
        'in Japan but wherever national-level cultural generalisations inform clinical '
        'decisions. The within-database confounder-adjustment methodology demonstrated here '
        'is directly replicable in other countries with national claims databases.'
    ),
    (
...
doc.add_paragraph('[Address], Japan')
doc.add_paragraph('E-mail: [email]')

outpath = os.path.join(BMJOPEN_DIR, 'BMJOpen_cover_letter.docx')
doc.save(outpath)
